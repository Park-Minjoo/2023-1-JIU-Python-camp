...
# 화면 타이틀 설정
pygame.display.set_caption("Euijin game") # 게임 이름
...
# 폰트 정의 먼저 폰트를 정의해야 한다
game_font = pygame.font.Font(None, 40) # 폰트 객체 생성 (폰트, 크기) none은 defalt 폰트
